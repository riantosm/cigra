...
type Props = RootStackScreenProps<typeof ROUTES.academyInsProgramDetail>;

export default function AcademyInsProgramDetailScreen(props: Props) {
  ...
  return (
    <AcademyScreen
      ...
      footer={
        <GradientButton
          label="Antrean Verifikasi Praktik"
          icon="clipboard-check"
          onPress={() =>
            navigation.navigate(ROUTES.academyRoot, { screen: ROUTES.academyTabVerifications })
          }
        />
      }>
      {detail ? (
        <>
          <Card style={styles.infoCard}>
            ...
            <InfoRow label="Nilai kelulusan" value={String(detail.pass_grade ?? '-')} />
            <InfoRow
              label="Deadline"
              value={detail.completion_deadline ? formatDateShort(detail.completion_deadline) : '-'}
              last
            />
          </Card>
